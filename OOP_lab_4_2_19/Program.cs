...
namespace lab_4_19_2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску - "); year = Console.ReadLine();
            Console.WriteLine("Дані про власника - "); fio = Console.ReadLine();
            Car car7 = new Car(name, color, number, Convert.ToInt32(year), fio);
            Console.WriteLine("Марка - "); name = Console.ReadLine();
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску - "); year = Console.ReadLine();
            Console.WriteLine("Дані про власника - "); fio = Console.ReadLine();
            Car car8 = new Car(name, color, number, Convert.ToInt32(year), fio);
            Console.WriteLine("Марка - "); name = Console.ReadLine();
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску - "); year = Console.ReadLine();
            Console.WriteLine("Дані про власника - "); fio = Console.ReadLine();
            Car car9 = new Car(name, color, number, Convert.ToInt32(year), fio);
            Console.WriteLine("Марка - "); name = Console.ReadLine();
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску - "); year = Console.ReadLine();
            Console.WriteLine("Дані про власника - "); fio = Console.ReadLine();
            Car car10 = new Car(name, color, number, Convert.ToInt32(year), fio);
            Console.WriteLine("Марка - "); name = Console.ReadLine();
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску- "); year = Console.ReadLine();
            ...
            Console.WriteLine("Рік випуску- "); year = Console.ReadLine();
            Console.WriteLine("Дані про власника - "); fio = Console.ReadLine();
            Car car6 = new Car(name, color, number, Convert.ToInt32(year), fio);
            Console.WriteLine("Марка - "); name = Console.ReadLine();
            Console.WriteLine("Колір - "); color = Console.ReadLine();
            Console.WriteLine("Номер - "); number = Console.ReadLine();
            Console.WriteLine("Рік випуску - "); year = Console.ReadLine();
